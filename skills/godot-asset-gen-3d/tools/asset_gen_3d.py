#!/usr/bin/env python3
"""3D Asset Generator CLI — GLB models via Tripo3D.
...
Subcommands:
  ...
  set_budget  Set the generation budget in cents (shared assets/budget.json)
...
def main():
    parser = argparse.ArgumentParser(description="3D Asset Generator — GLB models via Tripo3D")
